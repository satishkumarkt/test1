...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  constructor(public menuItems: MenuItems, private router: Router, private authService: AuthService) {
    ...
    this.headerFixedMargin = '80px'; // 50px
  ...
  setMenuAttributes(windowWidth) {
    if (windowWidth >= 768 && windowWidth <= 992) {
      ...
      this.verticalNavType = 'expanded';
      this.verticalEffect = 'shrink';
      this.toggleIcon = 'icon-chevrons-left';
    }
  ...
  toggleOpened(e) {
    ...
    this.toggleIcon = this.verticalNavType === 'expanded' ? 'icon-chevrons-left' : 'icon-chevrons-right';
