...
@Component({
  selector: 'app-internal-restricted-list',
  templateUrl: './internal-restricted-list.component.html',
  styleUrls: [
    './internal-restricted-list.component.scss',
...
export class InternalRestrictedListComponent implements OnInit {
