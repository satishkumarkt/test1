...
@Component({
  selector: 'app-beee-verification',
  templateUrl: './beee-verification.component.html',
  styleUrls: ['./beee-verification.component.scss',
...
export class BeeeVerificationComponent implements OnInit {
